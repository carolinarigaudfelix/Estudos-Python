...
caminho = os.path.join('/home/user', 'Desktop', 'cursos', 'arquivo.txt')
print(caminho)
diretorio, arquivo = os.path.split(caminho) #divide o caminho
caminho_arquivo, extensao_arquivo= os.path.splitext(arquivo) #split do arquivo
#e o nome do arquivo e seu tipo, txt. O split separa
# print(caminho_arquivo)
# print(arquivo)
# print(os.path.exists('\\Users\\carol\\OneDrive\\Área de Trabalho\\Estudos-Python'))
# print(os.path.abspath('.')) #absolute caminho
print(os.path.basename(caminho)) #basename da a parte final do caminho
