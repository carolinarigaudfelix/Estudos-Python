"""
Classe abstradas - Abstract Base Class (abc)
ABCs são usadas como contratos para a definição
de noas classes. Elas pdoem forçar outras classes
...
As regras para classes abstradas com métodos 
abstratos é que elas NÂO PODEM ser instânciadas
diretamente.
Métodos abstratos DEVEM ser implementados
nas subclasses (*abstractmethod)
Uma classe abstrata em Python tem sua metaclasse
sendo ABCMeta.  ->Classes criadas pra criar novas classes
